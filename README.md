# HASTANE-ACIL-SERVIS-UYGULAMASI (C DİLİ İLE)
...
Veri Yapıları: Dinamik Bağlı Listeler (Linked Lists) veya Kuyruklar (Queues).

Bellek Yönetimi: malloc ve free ile dinamik bellek tahsisi.
...
Modüler Kod: Okunabilir ve geliştirilebilir fonksiyon yapısı.
